...
export default function ComingSoon() {
  ...
  return (
    <section className="relative h-dvh flex items-center justify-center bg-primary-dark text-text-inverse overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-3xl px-6">
        <div className="flex flex-col items-center text-center gap-8 md:gap-12 lg:gap-10">
          <motion.div className="relative -translate-x-4" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: "easeOut" }}>
            ...
            <Image src="/logo.png" alt="Good Room House" width={1400} height={350} priority className="relative mx-auto h-auto w-96 md:w-[30rem] lg:w-[45rem]" />
          </motion.div>

          <div className="w-full md:ml-12">
          <motion.h1
            className="mt-2 md:mt-4 lg:mt-2 font-display text-4xl md:text-6xl tracking-[0.02em]"
          ...
          <motion.p
            className="mt-4 md:mt-6 lg:mt-4 max-w-2xl mx-auto font-body text-text-inverse/80"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.form
            onSubmit={onSubmit}
            className="mt-8 md:mt-10 lg:mt-8 flex items-center justify-center gap-2"
          ...
          <p className="mt-8 md:mt-10 lg:mt-6 text-xs italic text-text-inverse/70">“Quiet luxury isn’t about having more. It’s about feeling more.”</p>
